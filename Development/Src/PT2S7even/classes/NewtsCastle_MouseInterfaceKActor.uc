/*
	...
	* 
	* Credit: http://udn.epicgames.com/Three/DevelopmentKitGemsCreatingAMouseInterface.html#Adding%20a%20subclassed%20KActor%20as%20an%20example
	* 
	* Purpose: This is a kActor that responds to mouse inputs
	*/

class NewtsCastle_MouseInterfaceKActor extends KActor
		Implements(NewtsCastle_MouseInterfaceInteractionInterface);
